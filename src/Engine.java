public class Engine {
    ...
    public static Board engineMove(Board board, int timeLimit) {
        ...
        /*if (ponder != null && 1L<<MoveList.getStartSquare(ponder.ponderedMove) == board.startSquare && 1L<<MoveList.getEndSquare(ponder.ponderedMove) == board.endSquare) {
            ponder.killThread();
            principleVariation.copyPV(ponder.previousPV);
        }*/
        ...
        for (int i = 1; i < 30; i++) { //arbitrary depth limit
            ...
            if (temp != null) {
                ...
                //System.out.printf("Depth: %-2d Time: %-11s Nodes: %,-11d ", i, (endTime - startTime + "ms"), nodes);
