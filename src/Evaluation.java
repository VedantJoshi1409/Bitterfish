public class Evaluation {
    ...
    public static double evaluation(Board board) {
        ...
        while (currentBitBoard != 0) {
            ...
            if ((selectedPiece & board.fAttackMask) == 0) {
        ...
        while (currentBitBoard != 0) {
            ...
            if ((selectedPiece & board.eAttackMask) == 0) {
                protectionPenalty += PawnProtectionPenalty;
            }
        ...
        return materialDiff + positionalScore + endGameKingCorner + mobilityScore + defenseScore + protectionPenalty;
